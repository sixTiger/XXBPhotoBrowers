...
@interface XXBPhotoView()<UIScrollViewDelegate>
{
    BOOL _doubleTap;
    UIImageView *_imageView;
    XXBPhotoLoadingView *_photoLoadingView;
}
@end

@implementation XXBPhotoView
...
- (void)setupXXBPhotoView
{
    ...
    // 进度条
    _photoLoadingView = [[XXBPhotoLoadingView alloc] init];
